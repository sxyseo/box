(function() {
  ...
  initmenu = function() {
    var box, boxes, ib, items, _i, _j, _len, _len1, _ref;
    boxes = config.boxes;
    items = [];
  ...
  act = {
    list: function(e, env) {
      ...
      return $.post("" + config.rooturl + "/itsm/request/getFormListEditByUser.spr", null, function(result) {
        var form, out, teamField, teamList, version, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
        if (result.retCode) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          if ((_ref1 = teamField.teamList) != null ? _ref1[0] : void 0) {
            out.push("<ul>");
            _ref2 = teamField.teamList;
            for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
              teamList = _ref2[_j];
              out.push("<li teamId=\"" + teamList.teamId + "\"><span><i class=\"glyphicon glyphicon-minus\"></i> " + teamList.teamName + "</span>");
              if ((_ref3 = teamList.formList) != null ? _ref3[0] : void 0) {
                out.push("<ul>");
                _ref4 = teamList.formList;
                for (_k = 0, _len2 = _ref4.length; _k < _len2; _k++) {
                  form = _ref4[_k];
                  out.push("<li formId=\"" + form.formId + "\"><span><i class=\"glyphicon glyphicon-minus\"></i> " + form.formName + "</span>");
                  if ((_ref5 = form.formVersionList) != null ? _ref5[0] : void 0) {
                    out.push("<ul><li>");
                    _ref6 = form.formVersionList;
    ...
    preview: function(e, env) {
      return makeHtml(env, 1, function(err, html, rid) {
        ...
        _ref = env.rootcolumn.find("div.box[objinx]");
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          box = _ref[_i];
          try {
    ...
    save: function(e, env, opt) {
      ...
      if (!env.formName || type === 'newForm') {
        return $.post("" + config.rooturl + "/itsm/request/getFormListEditByUser.spr", function(result) {
          var form, nameForm, sel, team, teamList, teamfield, _i, _j, _len, _len1, _ref, _ref1;
          if (result.retCode) {
  ...
  $(function() {
    ...
    rootcolumn.mousedown(function(e) {
      ...
      if (env.focusBox) {
        inx = env.focusBox.attr('objinx');
        infoview = $("div.pubinfo>.infoview");
        if ((_ref = env.domobject[inx]) != null) {
          _ref.removePropertyView(infoview, env.focusBox);
        }
        env.focusBox.removeClass("boxactive");
        env.focusBox = null;
        $("div.pubinfo").empty();
    ...
    return $('ul.nav,div.modal').delegate('[act]', 'click', function(e) {
      ...
      at = t.attr('act').split('|');
      return typeof act[_name = at[0]] === "function" ? act[_name](e, env, at) : void 0;
    });
  });
